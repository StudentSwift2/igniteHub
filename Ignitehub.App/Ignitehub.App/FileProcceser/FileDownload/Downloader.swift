...
class Downloader {
    static func downloadFile() -> URL {
        let semaphore = DispatchSemaphore(value: 0);
        // Create destination URL
        let documentsUrl:URL =  FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!;
        let destinationFileUrl = documentsUrl.appendingPathComponent("Calender.ics");
        
        // Create URL to the source file
        let fileURL = URL(string: "https://ignitehubmc.com/events/list/?ical=1");
